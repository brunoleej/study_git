...
# fit
model.fit(x_train,y_train,batch_size = 16,shuffle=True,epochs = 5)
...
# DNN batch_size = 32, epoch = 5
# loss :  4.60522985458374
# accuracy:  0.009999999776482582

# DNN batch_size = 16, epoch = 5
# loss :  4.6052985191345215
# accuracy:  0.009999999776482582